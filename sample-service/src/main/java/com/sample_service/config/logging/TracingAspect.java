package com.sample_service.config.logging;
...
public class TracingAspect {
    ...
    @Around("@annotation(org.springframework.web.bind.annotation.GetMapping) && execution(* com.sample_service.rest.controller.*.*(..))")
